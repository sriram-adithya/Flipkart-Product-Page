...
//Column loop 
fetch("https://sandbox.nextleap.app/products/fetch")  //fetch method to get data from JSON web
.then(res => res.json())
.then(data => data.footer.colunms.forEach(colunmItem =>{
...
.then(data => data.footer.bottomColunms.forEach(bottomItem =>{
